...
Access SQL Server or Oracle package, stored procedure or function through the generic Web API - DbWebApi, like this: 
`http://BaseUrl/fully_qualified_name_of_stored_procedure/mediatype`  
from any http client, Get the results as JSON, XML, CSV, Excel xlsx, JSONP, and any text generated by Razor dynamic templating. For examples,
