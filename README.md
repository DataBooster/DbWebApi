...
With DbWebApi you can access SQL Server or Oracle package, stored procedure or function like 
`http://BaseUrl/fully_qualified_name_of_stored_procedure/mediatype`  
from any http client, Get the results as JSON, XML, CSV, Excel xlsx, JSONP, or any text generated by Razor dynamic templating. For examples,
